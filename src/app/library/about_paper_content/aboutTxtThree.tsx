export const PastThree = () => {
    return (
        <div className="flex flex-col gap-4 sm:w-fit max-w-[100ch]">
            ...
            <br></br><br></br>
            I decided to take the plunge and move on from labs to live projects. On our academy site, 
            I came across the Cloud Resume Challenge (CRC), by Forrest Brazeal. 
            This would help me bridge the gap between theory and practice. 
            </div>
        </div>
    )
    }